...
样本内夏普 1.63 / 回撤 −5.2%（2020-08~2026-08，已扣 0.15% 单边成本）。
...
亚洲腿 T-1，实测实盘夏普 1.63→~1.2）；21:30 时净值已补到 T-1~T（滞后降到
0~1 天，夏普 ~1.5）。代价：① 的监控从盘中变盘后。见 `scripts/archive/gate_lag_test.py`。
